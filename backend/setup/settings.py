...
SECRET_KEY = 'django-insecure-hm66j=*8h5)s^yymq(5embo9ea9znxh6na#6f5(0@cj(3q3pp0'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                 # Atualiza o token de refresh
    'BLACKLIST_AFTER_ROTATION': True,              # Bloqueia o token após rotação
}